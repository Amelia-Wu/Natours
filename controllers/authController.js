...
const createSendToken = (user, statusCode, res) => {
    ...
    //Set the secure as true only in the production environment
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
    ...
    const message = `Forgot your password? Submit your password and passwordConfirm to ${resetURL}.`
...
exports.resetPassword = catchAsync(async (req, res, next) => {
    // 1) Get the user based on the hashed token
...
exports.updatePassword = catchAsync(async (req, res, next) => {
    //This method will be executed after the protect method, which recorded the req.user
    //There is no info in the req, so we can only find the user by id
